...
public class PaymentFailedEventArgs extends PaymentEventArgs {

	private static final long serialVersionUID = -3287896855633009833L;

	GatewayType gatewayType;

	PaymentNotifyMethod paymentNotifyMethod;

	public PaymentFailedEventArgs(Object source) {
		super(source);
	 ...
	 *         支付结果的发送方式 ，以决定是应该输出标记已成功接收的字符串还是向用户显示支付成功的页面。服务器发送通知时属性为ServerNotify
